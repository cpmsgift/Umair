<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupervisorRegister.aspx.cs" Inherits="SupervisorRegister" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <center><h3>Register Supervisor</h3> </center>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-3">
                                ...
                                &nbsp;&nbsp;
                                <asp:Button ID="login" runat="server" Text="LOGIN" OnClick="login_Click" Width="80px" />
                            </div>
