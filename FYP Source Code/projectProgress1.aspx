        ...
        <div>
            ...
            <div id="navbar">
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
                    ...
                    <!-- Links -->
                    <ul class="navbar-nav">
                        <a class="nav-link" href="viewFRsSupervisor.aspx">View FRs
                        </a>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" id="navbardrop" data-toggle="dropdown">View Documents
                            </a>
                        ...
                        <a class="nav-link" href="conductMeeting1.aspx">Conduct Meeting
                        </a>

                        <a class="nav-link" href="">Project Grading
                        </a>
